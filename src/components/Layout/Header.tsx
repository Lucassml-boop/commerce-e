...
export const Header: React.FC = () => {
  ...
  const handleUserDropdownClick = (path: string) => {
    setShowUserDropdown(false)
    navigate(path)
  }
        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-8">
            <div className="flex-shrink-0">
              <Link to="/" className="text-3xl font-bold text-white flex items-center hover:text-blue-200 transition-colors">
                ...
                <div className="relative" ref={userDropdownRef}>
                  ...
                  {showUserDropdown && (
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                      ...
                      <button
                        onClick={() => handleUserDropdownClick('/admin')}
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">Gerenciar produtos</div>
                        </div>
                      </button>
